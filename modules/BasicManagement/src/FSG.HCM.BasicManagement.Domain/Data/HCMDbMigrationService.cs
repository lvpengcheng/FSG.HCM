...
{
    public class HCMDbMigrationService : ITransientDependency
    {
        private ILogger<HCMDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IHCMDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public HCMDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IHCMDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<HCMDbMigrationService>.Instance;
        }
