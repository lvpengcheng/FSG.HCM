using FSG.HCM.DataDictionaryManagement.DataDictionaries.Aggregates;
using FSG.HCM.LanguageManagement.EntityFrameworkCore;
using FSG.HCM.LanguageManagement.Languages.Aggregates;
using FSG.HCM.LanguageManagement.LanguageTexts.Aggregates;
using FSG.HCM.NotificationManagement.Notifications.Aggregates;
...
namespace FSG.HCM.EntityFrameworkCore
{
    ...
    public class HCMDbContext : AbpDbContext<HCMDbContext>, IHCMDbContext,
