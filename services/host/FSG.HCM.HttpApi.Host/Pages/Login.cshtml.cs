...
using FSG.HCM.BasicManagement.ConfigurationOptions;
using FSG.HCM.BasicManagement.Users;
using FSG.HCM.BasicManagement.Users.Dtos;
using Microsoft.AspNetCore.Mvc.RazorPages;
using Volo.Abp.Timing;


namespace FSG.HCM.Pages
{
    public class Login : PageModel
    {
        ...
        public async Task OnPost()
        {
            ...
            try
            {
                ...
                // 设置cookies domain
                //options.Domain = "HCM.cn";


                var result = await _accountAppService.LoginAsync(new LoginInput()
                { Name = userName, Password = password });
                Response.Cookies.Append(HCMHttpApiHostConst.DefaultCookieName,
