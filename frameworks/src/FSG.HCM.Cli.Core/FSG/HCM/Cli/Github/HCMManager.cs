...
namespace FSG.HCM.Cli.Github;

public class HCMManager : ITransientDependency, IHCMManager
{
    private readonly HCMCliOptions _cliOptions;
    private readonly IHttpClientFactory _httpClientFactory;

    public HCMManager(IOptions<HCMCliOptions> options, IHttpClientFactory httpClientFactory)
    {
