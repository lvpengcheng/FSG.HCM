...
public class HCMCliCoreModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<Options.HCMCliOptions>(options =>
        {
            ...
            options.Templates = new List<HCMTemplateOptions>()
            {
                new HCMTemplateOptions("abp-vnext-pro", "pro", "源码版本", true)
                {
                    ExcludeFiles = "templates,docs,.github,LICENSE,Readme.md",
                    ReplaceSuffix = ".sln,.csproj,.cs,.cshtml,.json,.ci,.yml,.yaml,.nswag,.DotSettings,.env,Directory.Build.FSG.targets",
                    OldCompanyName = "FSG",
                    OldProjectName = "HCM"
                },
                new HCMTemplateOptions("abp-vnext-pro-nuget-all", "pro.all", "Nuget完整版本")
                {
                ...
                new HCMTemplateOptions("abp-vnext-pro-nuget-simplify", "pro.simplify", "Nuget简单版本")
                {
                ...
                new HCMTemplateOptions("abp-vnext-pro-nuget-module", "pro.module", "模块")
                {
