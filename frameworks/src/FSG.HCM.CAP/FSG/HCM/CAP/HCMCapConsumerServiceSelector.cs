...
public class HCMCapConsumerServiceSelector : ConsumerServiceSelector, ISingletonDependency
{
    ...
    /// </summary>
    public HCMCapConsumerServiceSelector(IServiceProvider serviceProvider, IOptions<AbpDistributedEventBusOptions> distributedEventBusOptions) : base(serviceProvider)
    {
