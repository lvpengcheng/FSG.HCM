...
public class HCMCapDistributedEventBus : EventBusBase, IDistributedEventBus, ISingletonDependency
{
    ...
    public HCMCapDistributedEventBus(IServiceScopeFactory serviceScopeFactory,
        ...
        bool useOutbox = true)
    {
        ...
        {
            if (UnitOfWorkManager.Current is not HCMCapUnitOfWork capUnitOfWork || capUnitOfWork.CapTransaction is null)
            {
